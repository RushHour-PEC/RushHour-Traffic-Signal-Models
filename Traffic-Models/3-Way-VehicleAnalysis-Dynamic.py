...
# header = ['P1', 'P2', 'P3', 'Lane1', 'Lane2', 'Lane3', 'Total']
# with open('../data/CaseStudy/3-Way-System/3-Way-Analysis-Dynamic-Case-15.csv', 'w', encoding='UTF8', newline='') as f:
#     writer = csv.writer(f)
#     # write the header
...
x = {'right': [0, 0], 'down': [740, 706], 'left': [1400, 1400]}
y = {'right': [360, 395], 'down': [0, 0], 'left': [479, 439]}


# Coordinates of signal image, timer, and vehicle count
signalCoods = [(530, 230), (810, 230), (810, 570)]
signalTimerCoods = [(530, 210), (810, 210), (810, 550)]
vehicleCountCoods = [(480, 210), (880, 210), (880, 550)]
...
stops = {'right': [580, 580], 'down': [320, 320], 'left': [810, 810]}


mid = {'right': {'x': 720, 'y': 445}, 'down': {
    'x': 695, 'y': 460}, 'left': {'x': 680, 'y': 425}}
rotationAngle = 3
...
vehicles = {'right': {0: [], 1: [], 'crossed': 0}, 'down': {
    0: [], 1: [], 'crossed': 0}, 'left': {0: [], 1: [], 'crossed': 0}}
...
def generateVehicles():
    ...
    while(True):
        ...
        elif((direction_number == 0 and lane_number == 0) or
             (direction_number == 2 and lane_number == 1)):
...
def simulationTime():
    ...
    while(True):
        ...
        if(timeElapsed == simTime):
            ...
            with open('../data/CaseStudy/3-Way-System/3-Way-Analysis-Dynamic-Case-15.csv', 'a', newline='') as f:
                writer = csv.writer(f)
...
class Main:
    ...
    background = pygame.image.load(
        '../images/intersection/intersection-3-Way.png')
