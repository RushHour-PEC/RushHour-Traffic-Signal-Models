...
# with open('../data/CaseStudy/3-Way-System/3-Way-Analysis-Static-Case-15.csv', 'w', encoding='UTF8', newline='') as f:
#     writer = csv.writer(f)
...
def simulationTime():
    ...
    while(True):
        ...
        if(timeElapsed == simTime):
            ...
            with open('../data/CaseStudy/3-Way-System/3-Way-Analysis-Static-Case-15.csv', 'a', newline='') as f:
                writer = csv.writer(f)
